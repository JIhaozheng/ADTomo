...
static void backward(
    ...
    // Bulk continuous adjoint only: retain the source arguments for the API
    // but disable the source-corner derivative treatment.
    solve_adjoint_fsm_0f_src(lambda.data(), u, delta.data(), m, n, l, h, x, y, z, false);
